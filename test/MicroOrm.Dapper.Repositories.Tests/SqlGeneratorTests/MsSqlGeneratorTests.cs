...
namespace MicroOrm.Dapper.Repositories.Tests.SqlGeneratorTests
{
    public class MsSqlGeneratorTests
    {
        ...
        public static void BoolFalseEqualNotPredicate()
        {
            ...
            var sqlQuery = userSqlGenerator.GetSelectFirst(x => x.IsActive != true, true);
        ...
        {
            ISqlGenerator<Phone> userSqlGenerator = new SqlGenerator<Phone>(_sqlConnector, true);
            var sqlQuery = userSqlGenerator.GetSelectFirst(x => x.IsActive == false, true);
        ...
        {
            ISqlGenerator<User> userSqlGenerator = new SqlGenerator<User>(_sqlConnector, true);
            var sqlQuery = userSqlGenerator.GetSelectFirst(x => x.Phone.Number == "123", true, user => user.Phone);
        ...
        {
            ISqlGenerator<User> userSqlGenerator = new SqlGenerator<User>(_sqlConnector, true);
            var sqlQuery = userSqlGenerator.GetSelectById(1, true);
        ...
        {
            ISqlGenerator<User> userSqlGenerator = new SqlGenerator<User>(_sqlConnector, true);
            var sqlQuery = userSqlGenerator.GetSelectFirst(x => x.Id == 2, true);
