...
namespace MicroOrm.Dapper.Repositories
{
    ...
    public interface IDapperRepository<TEntity> where TEntity : class
    {
        ...
        ///     Bulk Update objects in DB
        /// </summary>
        Task<bool> BulkUpsertAsync(IEnumerable<TEntity> instances);

        /// <summary>
        /// Bulk Upsert objects in DB
        /// </summary>
        Task<bool> BulkUpsertAsync(IEnumerable<TEntity> instances, IDbTransaction transaction);
