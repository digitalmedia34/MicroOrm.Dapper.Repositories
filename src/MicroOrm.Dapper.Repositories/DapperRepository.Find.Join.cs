...
namespace MicroOrm.Dapper.Repositories
{
        ...
        where TEntity : class
    {
        ...
        {
            var queryResult = SqlGenerator.GetSelectFirst(predicate, false, tChild1);
        ...
        {
            var queryResult = SqlGenerator.GetSelectFirst(predicate, false, tChild1, tChild2);
        ...
        public virtual TEntity Find<TChild1, TChild2, TChild3>(Expression<Func<TEntity, bool>> predicate,
            ...
            IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectFirst(predicate, false, tChild1, tChild2, tChild3);
        ...
        public virtual TEntity Find<TChild1, TChild2, TChild3, TChild4>(Expression<Func<TEntity, bool>> predicate,
            ...
            IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectFirst(predicate, false, tChild1, tChild2, tChild3, tChild4);
        ...
        public virtual TEntity Find<TChild1, TChild2, TChild3, TChild4, TChild5>(Expression<Func<TEntity, bool>> predicate,
            ...
            IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectFirst(predicate, false, tChild1, tChild2, tChild3, tChild4, tChild5);
        ...
        public virtual TEntity Find<TChild1, TChild2, TChild3, TChild4, TChild5, TChild6>(Expression<Func<TEntity, bool>> predicate,
            ...
            IDbTransaction transaction = null)
        {
            var queryResult = SqlGenerator.GetSelectFirst(predicate, false, tChild1, tChild2, tChild3, tChild4, tChild5, tChild6);
