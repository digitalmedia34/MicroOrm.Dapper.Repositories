...
namespace MicroOrm.Dapper.Repositories.SqlGenerator
{
    ...
    public interface ISqlGenerator<TEntity> where TEntity : class
    {
        ...
        /// <summary>
        /// Get SQL for bulk upsert operation
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
        SqlQuery GetBulkUpSert(IEnumerable<TEntity> entities);
        ...
        /// <summary>
        /// Get SQL for UPSERT Query
        /// </summary>
        SqlQuery GetUpSert(TEntity entity);

        /// <summary>
        ///     Get SQL for SELECT Query by Id
        /// </summary>
        SqlQuery  GetSelectById(object id, bool firstOnly, params Expression<Func<TEntity, object>>[] includes);

        /// <summary>
        ///     Get SQL for SELECT Query
        /// </summary>
        SqlQuery GetSelectFirst(Expression<Func<TEntity, bool>> predicate, bool firstOnly, params Expression<Func<TEntity, object>>[] includes);
