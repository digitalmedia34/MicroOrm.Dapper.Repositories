...
namespace MicroOrm.Dapper.Repositories
{
        ...
        where TEntity : class
    {
        ...
        public virtual TEntity FindById(object id, IDbTransaction transaction)
        {
            ...
            return TransientDapperExtentions.QuerySingleOrDefaultWithRetry(() => Connection.QuerySingleOrDefault<TEntity>(queryResult.GetSql(), queryResult.Param, transaction));
        }
